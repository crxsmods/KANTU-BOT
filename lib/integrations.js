...
export const integrationConfig = Object.freeze({
  ...
  mitzuki: Object.freeze({
    url: env('MITZUKI_API_URL') || 'https://api.mitzuki.xyz',
    apiKey: env('MITZUKI_API_KEY') || 'elrebelde21'
  }),
  ...
  savetube: Object.freeze({ aesKey: env('SAVETUBE_AES_KEY') })
})
...
const configured = Object.freeze({
  ...
  mitzuki: () => Boolean(integrationConfig.mitzuki.apiKey),
