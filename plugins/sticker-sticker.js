...
if (/video/g.test(mime)) if ((q.msg || q).seconds > 18) return m.reply('⚠️ ¿Dónde has visto un sticker de 15 segundos? Haz el video más corto, con un máximo de 12 segundos.')
let img = await q.download?.()
if (!img) return m.reply(`🫵 Responde a un video o imagen*\n> *Usa:* ${usedPrefix + command}`) 
let out
try {
